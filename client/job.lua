...
function OpenCloakroomMenu()
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		elements = {
			...
			{label = "Tenue Chirurgien", value = 'ambulance2_wear'},
		}
	}, function(data, menu)
		if data.current.value == 'citizen_wear' then
			...
			enService = false
			exports["rp-radio"]:GivePlayerAccessToFrequencies(1, 2, 3, 4, 5, 6, 7, 8)  -----RP RADIO
		...
		elseif data.current.value == 'ambulance_wear' then
			...
			enService = true
			exports["rp-radio"]:RemovePlayerAccessToFrequencies(1, 2, 3, 4, 5, 6, 7, 8)  ------RP RADIO
...
function drawLoadingText(text, red, green, esx, alpha)
	SetTextFont(4)
	SetTextScale(0.0, 0.5)
	SetTextColour(red, green, esx, alpha)
